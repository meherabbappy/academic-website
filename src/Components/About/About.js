    ...
    <div className="container">
        ...
        <div className="row">
            <div className="col-md-4 text-center">
                <img className="img-fluid qualities-img p-4 rounded-circle" src="https://ath2.unileverservices.com/wp-content/uploads/sites/3/2017/09/professional-mens-hairstyles-light-styling-min.jpg" alt="" />
                <h5>
                    CEO
                </h5>
                <p>
            ...
            <div className="col-md-4 text-center">
                <img className="img-fluid qualities-img p-4 rounded-circle" src="https://media.istockphoto.com/photos/african-american-businessman-smiling-on-grey-picture-id1138563417?k=20&m=1138563417&s=612x612&w=0&h=zeW4F-XuCQAka4lGUFxzXoCue4ZjasG1JpUAr1tO8_A=" alt="" />
                <h5>
                    Business Analyst
                </h5>
                <p>
            ...
            <div className="col-md-4 text-center">
                ...
                <img className="img-fluid qualities-img p-4 rounded-circle" src="https://static9.depositphotos.com/1325771/1218/i/600/depositphotos_12185281-stock-photo-happy-smart-business-man.jpg" alt="" />
                <h5>
                    Senior HR
                </h5>
                <p>
        ...
        <div className="row mb-md-3">
            <div className="col-md-4 text-center">
                <img className="img-fluid qualities-img p-4 rounded-circle" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMaZqulYzUa8PZOUOM5fZ4oXDDWvWY5EN7WI1V7PF7RkGilk5g8jhiD--22utKgK2Gcew&usqp=CAU' alt="" />
                <h5>
                   React Developer
                </h5>
                <p>
            ...
            <div className="col-md-4 text-center">
                <img className="img-fluid qualities-img p-4 rounded-circle" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkfvSCritAj_5LPu16Y8fqTFotHBRi3ilnfIIaHLeQYmtsur5AL-3Kvy4R85CUv7wiq9g&usqp=CAU" alt="" />
                <h5>
                    Marketing Head
                </h5>
                <p>
            ...
            <div className="col-md-4 text-center">
                <img className="img-fluid qualities-img p-4 rounded-circle" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ81kdIkUsAiZKEwy_JaSIQQ-KLOlLOav30tQ&usqp=CAU" alt="" />
                <h5>
                    Software Head
                </h5>
                <p>
            ...
            <div className='about-child'>
                ...
                <FontAwesomeIcon className= "icon-img" icon={faGraduationCap} />
                    ...
                    <p className= "p-items">
                    Our programs are designed to bring the Harvard Business School classNameroom to you. Find out how.</p>
                </div>
                <div className="about-items">
